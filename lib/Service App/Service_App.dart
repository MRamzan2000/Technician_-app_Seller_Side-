...
//   final places =
//       GoogleMapsPlaces(apiKey: 'AIzaSyBvNhzLGOSUILk4xtwuGpMBtct3L4790-I');
...
//               target: latitude == 0.0 && longitude == 0.0
//                   ? LatLng(31.453246, 74.293170)
...
//                           right: 0,
//                           bottom: 40,
//                           // Set the bottom value to the height of the text field container
...
//                             ),
//                             height: 40,
//                             // Updated the height to 40 for a better visual appearance
...
//                             await places.autocomplete("Lahore", types: [
//                               '(cities)'
//                             ]).then((value) => {
...
//           await places.autocomplete(query, types: ['(cities)']);
//       print(query);
