...
class _ChatScreenState extends State<ChatScreen> {
    ...
    if (!_isLoading) {
      ...
      try {
        final response = await http.get(
          Uri.parse('https://seahorse-app-cvm3d.ondigitalocean.app/messages/${widget.myUserId}/${widget.otherUserId}/$_page/?lastMessageId=$_lastMessageId'),
  ...
  void connectToServer() {
    try {
      ...
      socket = IO.io('https://seahorse-app-cvm3d.ondigitalocean.app/',IO.OptionBuilder().setTransports(['websocket']).disableAutoConnect().build());
    } catch (e) {
      print("hello");
      print(e.toString());
    }
